...
export default function Hero() {
  return (
    <div className=" rounded-lg grid place-items-center  h-96 lg:h-100 bg-cover bg-center bg-no-repeat mt-8 mx-4 relative" style={{ backgroundImage: "url(" + Background + ")" }}>
