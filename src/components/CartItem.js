...
export default function CartItem ({name,price,image}) {
    ...
    return (
        <>
            <li className="flex flex-col w-full md:w-2/4 py-6  ">
                <div className="flex   space-x-2 sm:space-x-4 pr-4">
                    ...
                    <div className="flex flex-col justify-between w-full pb-4">
                        ...
                        <div className="flex text-sm divide-x">
                            <button type="button" onClick={removeItem} className="flex items-center px-2 py-1 pl-0 space-x-1">
