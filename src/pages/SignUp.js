                    ...
                    <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                        ...
                        <form >
                            ...
                            <div className="text-center mt-6">
                                <button disabled={!btnState} onClick={handleSubmit} className="bg-orange-600  active:bg-orange-700 text-white text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150" type="button"> Sign Up </button>
                            </div>
                        </form>
                    </div>
                </div>
